---
# title: "MVMR example for Supplementary Material"
# author: "Tom Palmer"
...
<!-- custom-reference.docx created from pandoc with, at command line -->
...
suppressPackageStartupMessages({
  ...
  if (!requireNamespace("MendelianRandomization")) install.packages("MendelianRandomization")
  if (!requireNamespace("MVMR")) remotes::install_github("wspiller/mvmr")
  if (!requireNamespace("Statamarkdown")) remotes::install_github("hemken/statamarkdown")  
})
```
...
gitget mrrobust // output suppressed
```
...
```{r}
if (!requireNamespace("sessioninfo")) install.packages("sessioninfo")
